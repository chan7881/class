...
export function PreviewFrame({ lesson, code, initialSlideIndex }: { lesson: Lesson; code: string; initialSlideIndex: number }) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      >
        <Player lesson={lesson} code={code} adapter={createPreviewAdapter(lesson)} mode="preview" initialSlideIndex={initialSlideIndex} />
      </div>
    </div>
  )
}
